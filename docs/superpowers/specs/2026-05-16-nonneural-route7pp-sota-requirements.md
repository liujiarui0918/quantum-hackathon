...
| B | 610.266639 | 610.266639 | 0.00% | 可行且最优 |

A/B 样例均已达到官方最优。当前最稳主线应继续沿 MIQP-aware route7++ 推进：保留连续变量 LP 子问题，用结构化 block、repair、LP cache、cut advice 和 seed/config portfolio 处理明早真实实例。
